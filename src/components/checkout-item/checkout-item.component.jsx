...
import { CheckoutItemContainer,ImageContainer, CheckoutImage, CheckoutItemDetailsContainer,QuantityContainer, RemoveButtonContainer } from './checkout-item.styles';
